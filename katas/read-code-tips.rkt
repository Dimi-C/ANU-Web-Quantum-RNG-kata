...
(define tips
  (list
   ...
   `004-easy
   (read "You can change the amount of numbers lised in the function call by changing the number ex.[9] to return up to 1024 random numbers between 0-255.")

   `005-easy
   (read "You can change the amount of numbers lised in the function call by changing the number ex.[10] to return up to 1024 random numbers between 0-65,535.")
